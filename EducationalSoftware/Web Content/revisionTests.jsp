...
<body onload='loadHtml("side", "studentSidebar.jsp")'>
	...
	<div class="wrapper">
		...
		<div id="content">
			...
			Dao dao = new Dao();
			dao.increaseVisitedCounter(email, "revisionTest");
			...
			for (int i = 0; i < 5; i ++) {
				questions[i] = dao.pickRandomRevisionQuestions("chapter1_multipleChoice", "chapter2_multipleChoice");
			}
			...
			<input type="hidden" name="revisionTest" value="revisionTest">
			
			<h5 style="color:#f65868">Revision multiple choice test - Select the answer you think is correct from the options given.</h5>
			<br>
