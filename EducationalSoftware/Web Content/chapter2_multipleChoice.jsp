...
<head>
<title>Chapter 2 Multiple Choice</title>
<meta charset="utf-8">
...
<body onload='loadHtml("side", "studentSidebar.jsp")'>
	...
	<div class="wrapper">
		...
		<div id="content">
			...
			Dao dao = new Dao();
			dao.increaseVisitedCounter(email, "chapter2_multipleChoice");
			...
			for (int i = 0; i < 5; i ++) {
				questions[i] = dao.pickRandomQuestions("chapter2_multipleChoice");
			}
