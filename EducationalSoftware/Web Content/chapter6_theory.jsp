...
<head>
<title>Membership Operators Example</title>
<meta charset="utf-8">
...
<body onload='loadHtml("side", "studentSidebar.jsp")'>
	...
	<div class="wrapper">
		...
		<div id="content">
			...
			Dao dao = new Dao();
			dao.increaseVisitedCounter(email, "chapter6_theory");
			%>
			
			<p class="theory"><b style="font-size: 25px">Membership operators</b> are used to test if a sequence is presented in an object:</p>
			<br>
