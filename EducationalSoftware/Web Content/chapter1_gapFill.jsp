...
<body onload='loadHtml("side", "studentSidebar.jsp")'>
	...
	<div class="wrapper">
		...
		<div id="content">
			...
			Dao dao = new Dao();
			dao.increaseVisitedCounter(email, "chapter1_gapFill");
			...
			for (int i = 0; i < 5; i ++) {
				questions[i] = dao.pickRandomQuestions("chapter1_gapFill");
			}
			...
			<input type="hidden" name="chapter_name" value="chapter1_multipleChoice">
