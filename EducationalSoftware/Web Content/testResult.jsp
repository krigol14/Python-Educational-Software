		...
		<div id="content">
			...
			<div class="card text-white <%=color1%> mb-3">
			  ...
			  <% if (color1.equals("bg-danger")) { %>
				  <div class="card-body">
				    <p style="color: #fff">Your answer: <%=useranswer1%></p>
				    <p style="color: #fff">Correct answer: <%=answer1%></p>
				  </div>
			  <% } %>
			</div><br>
			...
			<div class="card text-white <%=color2%> mb-3">
			  ...
			  <% if (color2.equals("bg-danger")) { %>
				  <div class="card-body">
				    <p style="color: #fff">Your answer: <%=useranswer2%></p>
				    <p style="color: #fff">Correct answer: <%=answer2%></p>
				  </div>
			  <% } %>
			</div><br>
			...
			<div class="card text-white <%=color3%> mb-3">
			  ...
			  <% if (color3.equals("bg-danger")) { %>
				  <div class="card-body">
				    <p style="color: #fff">Your answer: <%=useranswer3%></p>
				    <p style="color: #fff">Correct answer: <%=answer3%></p>
				  </div>
			  <% } %>
			</div><br>
			...
			<div class="card text-white <%=color4%> mb-3">
			  ...
			  <% if (color4.equals("bg-danger")) { %>
				  <div class="card-body">
				    <p style="color: #fff">Your answer: <%=useranswer4%></p>
				    <p style="color: #fff">Correct answer: <%=answer4%></p>
				  </div>
			  <% } %>
			</div><br>
			...
			<div class="card text-white <%=color5%> mb-3">
			  ...
			  <% if (color5.equals("bg-danger")) { %>
				  <div class="card-body">
				    <p style="color: #fff">Your answer: <%=useranswer5%></p>
				    <p style="color: #fff">Correct answer: <%=answer5%></p>
				  </div>
			  <% } %>
			</div> 
