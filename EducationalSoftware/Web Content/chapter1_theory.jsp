...
<body onload='loadHtml("side", "studentSidebar.jsp")'>
	...
	<div class="wrapper">
		...
		<div id="content">
			...
			Dao dao = new Dao();
			dao.increaseVisitedCounter(email, "chapter1_theory");
			%>
			
			<p class="theory"><b style="font-size: 25px">Arithmetic operators</b> are used with numeric values to perform common mathematical operations:</p>
			<br>
