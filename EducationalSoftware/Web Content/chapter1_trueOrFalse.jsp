...
<head>
<title>Chapter 1 True or False</title>
<meta charset="utf-8">
...
<body onload='loadHtml("side", "studentSidebar.jsp")'>
	...
	<div class="wrapper">
		...
		<div id="content">
			...
			Dao dao = new Dao();
			dao.increaseVisitedCounter(email, "chapter1_trueOrFalse");
			...
			for (int i = 0; i < 5; i ++) {
				questions[i] = dao.pickRandomQuestions("chapter1_trueOrFalse");
			}
			...
			<input type="hidden" name="trueOrFalse" value="trueOrFalse">
			<input type="hidden" name="email" value=<%=email%>>
			
			<h5 style="color:#f65868">True or false test - Select true or false whether you think the statement is correct or not.</h5>
			<br>
